namespace Presentation.Api
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IFlightDistanceCalculatorService, FlightDistanceCalculatorService>();
            container.RegisterType<IFlightService, FlightService>(
                new InjectionConstructor(new ResolvedParameter<IFlightRepository>(), 
                new ResolvedParameter<IAirportRepository>(),
                new ResolvedParameter<IFlightDistanceCalculatorService>()));
        }
    }
}